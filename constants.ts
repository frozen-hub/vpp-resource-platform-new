...
const getDefaultDistricts = (cityName: string) => [`${cityName}区1`, `${cityName}区2`];

// Data structure: Province -> City -> District[]
export const CHINA_LOCATIONS: Record<string, Record<string, string[]>> = {
  ...
  '江西省': {
    '南昌市': ['东湖区', '西湖区', '青云谱区', '湾里管理局', '青山湖区', '新建区'],
    '景德镇市': ['昌江区', '珠山区'],
    '萍乡市': ['安源区', '湘东区'],
    '九江市': ['濂溪区', '浔阳区', '柴桑区'],
    '新余市': ['渝水区'],
  ...
  '重庆市': { '重庆市': ['万州区', '涪陵区', '渝中区', '大渡口区', '江北区', '沙坪坝区', '九龙坡区', '南岸区', '北碚区', '渝北区', '巴南区', '长寿区', '江津区', '合川区', '永川区', '南川区', '綦江区', '大足区', '璧山区', '铜梁区', '潼南区', '荣昌区', '开州区', '梁平区', '武隆区'] },
  '四川省': {
